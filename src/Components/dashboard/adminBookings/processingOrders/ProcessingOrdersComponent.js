...
import './ProcessingOrdersStyles.css'
import Loading from '../../../loading/Loading';
const ProcessingOrdersComponent = () => {

    const { allBookings,loading, error: bookingErrors } = useSelector((state) => state.allBookings);
    ...
    return (
        ...
        <div className='processing-orders-main-container'>
            <div className='component-heading'><h1><p className='animation-heading'>PROCESSING ORDERS</p></h1></div>
            {/* <h1>Admin users</h1> */}
