...
import './CompletedOrdersStyles.css'
...
const CompletedOrdersComponent = () => {
    ...
    React.useEffect(() => {
        ...
        if(bookingErrors)
        {
            if(bookingErrors==='Please login first')
    ...
    return (
        ...
        <div className='completed-orders-main-container'>
            <div className='component-heading'><h1><p className='animation-heading'>COMPLETED ORDERS</p></h1></div>
            {/* <h1>Admin users</h1> */}
            <dialog id='edit-booking-modal' className='edit-booking-modal-class'>
                ...
                <div id='modal-buttons'>
                    ...
                    <button onClick={closeEditBookingModalMethod} >Close</button>
                </div>
            </dialog>
